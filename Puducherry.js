...
var questions = ["What is the total number of districts in Puducherry?", "Who was the first Cheif Minister of Puducherry?", "Which one is the state bird of Puducherry?", "In which year, was Puducherry integrated to India?", "Which one is the state animal of Puducherry?", "In which year Puducherry became a French colonial possession?", "In which year Pondicherry university was established?", "The Mahe district is surrounded by which state?", "Who was the first Lieutenant Governor of Puducherry?", "What is the total number of Assembly constituencies in Puducherry?", "Which lake is located in Puducherry?", "In which region, Gingee river is located?", "Which one is the largest district of Puducherry?", "Which districh has the highest density of population?", "Puducherry was formed out of ______exclaves of Former French India.", "Puducherry lies in the ______ part of the Indian Peninsula.", "The area of Puducherry district is bound by the state of?", "The area of Karaikal district is bound by the state of?", "Yanam district is enclosed by the state of?", "Mahé district is enclosed by the state of?", "Puducherry is the ______ most populous state/union territory in India.", "Puducherry is the ______ most densely populated state/union territory.", "Puducherry has a GDP of ______ lakh crore.", "Puducherry's GDP rank ______ in India."];
var optAs = ["3", "M.O.H Farook", "Eagle", "1960", "Chital", "1674", "1976", "Karnataka", "S.L. Silam", "26", "Oustery Lake", "Mahe Region", "Karaikal", "Karaikal", "Four", "Northern", "Odisha", "Andhra Pradesh", "Andhra Pradesh", "Odisha", "25th", "Third", "₹0.21", "21st"];
var optBs = ["4", "VenkatasubhaReddiar", "Dove", "1962", "Deer", "1679", "1981", "Goa", "B.D. Jatti", "30", "Kaylana Lake", "Karaikal Region", "Pondicherry", "Pondicherry", "Seven", "Western", "Kerala", "Tamil Nadu", "Kerala", "Tamil Nadu", "31st", "Fifth", "₹0.35", "24th"];
var optCs = ["5", "Edouard Goubert", "Pigeon", "1965", "Tiger", "1688", "1985", "Tamil Nadu", "Chhedilal", "32", "Anshupa Lake", "Puducherry Region", "Mahe", "Mahe", "Three", "Eastern", "Tamil Nadu", "Kerala", "Odisha", "Kerala", "20th", "Second", "₹0.18", "27th"];
var optDs = ["6", "Subramanyan Ramaswamy", "Koel", "1969", "Squirrel", "1695", "1989", "Kerala", "K.M. Chandy", "35", "Chilika Lake", "Yanam Region", "Yanam", "Yanam", "Five", "Southern", "Andhra Pradesh", "Odisha", "Tamil Nadu", "Andhra Pradesh", "29th", "Sixth", "₹0.27", "25th"];
function draw(){
    ...
    if(questionNo == 0 || questionNo == 3 || questionNo == 8 || questionNo == 15 || questionNo == 18 || questionNo == 21 || questionNo == 25){
    ...
    if(questionNo == 2 || questionNo == 5 || questionNo == 11 || questionNo == 14 || questionNo == 19){
        optA.onclick = function(){
    ...
    if(questionNo == 4 || questionNo == 6 || questionNo == 9 || questionNo == 17 || questionNo == 22){
        optA.onclick = function(){
            optC.style.border = "3px solid #CC9E88";
            optC.style.background = "#CC9E88";
            optA.style.background = "#CC9E88";
    ...
    if(questionNo == 7 || questionNo == 10 || questionNo == 12 || questionNo == 13 || questionNo == 16 || questionNo == 20 || questionNo == 23 || questionNo == 24){
        optA.onclick = function(){
            optC.style.border = "3px solid #CC9E88";
            optC.style.background = "#CC9E88";
            optB.style.background = "#CC9E88";
