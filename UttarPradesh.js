...
function draw(){
    ...
    if(questionNo == 0 || questionNo == 6 || questionNo == 10 || questionNo == 13 || questionNo == 15 || questionNo == 18 || questionNo == 22 || questionNo == 23 || questionNo == 25 || questionNo == 31 || questionNo == 35 || questionNo == 41 || questionNo == 42 || questionNo == 35 || questionNo == 49){
        optA.onclick = function(){
